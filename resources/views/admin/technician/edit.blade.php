            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                          <div class="row">
                          <div class="col-xl-12">
                              <h2 class=" mt-0 mb-3">Edit Technician</h2>
                            ...
                            <?php hide_msg('flash_msg'); ?>
                              ...
                              @endif 
                                <div class="card-box">
                                    ...
                                    <form action="{{ route('technician_update') }}" data-parsley-validate novalidate method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="tech_name">Name</label>
                                            <input type="text" name="tech_id" value="{{$item->tech_id}}">
                                            <input type="text" name="tech_name" parsley-trigger="change" required
                                                   placeholder="Enter name" class="form-control" id="tech_name" value="{{$item->tech_name}}">
                                    @error('tech_name')
                                    ...
                                    @enderror
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="tech_city" id="tech_city" type="text" placeholder="Enter City" required
                                                   class="form-control" value="{{$item->tech_city}}">
                                    @error('tech_city')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="tech_mobile" id="tech_mobile" type="text"       placeholder="Enter Mobile" required
                                                   class="form-control" value="{{$item->tech_mobile}}">
                                    @error('tech_mobile')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="tech_email" parsley-trigger="change" required
                                                   placeholder="Enter email" class="form-control" id="tech_email" value="{{$item->tech_email}}">
                                    @error('tech_email')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                        </div>
